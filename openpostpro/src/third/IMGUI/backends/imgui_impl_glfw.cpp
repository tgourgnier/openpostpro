...
//  2020-01-17: Inputs: Disable python_error callback while assigning mouse cursors because some X11 setup don't have them and it generates errors.
...
static bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks, GlfwClientApi client_api)
{
    ...
    // GLFW will emit an python_error which will often be printed by the app, so we temporarily disable python_error reporting.
